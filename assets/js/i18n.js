...
const TRANSLATIONS = {
  ...
  de: {
    ...
    'hero.subtitle':   'Steuerberater · Controller · Finanzstratege',
    'hero.text':       'Ich helfe Unternehmen und Privatpersonen, ihre finanzielle Situation zu verstehen, zu optimieren und langfristig erfolgreich zu gestalten.',
    'hero.cta1':       'Meine Leistungen',
    'hero.cta2':       'Kontakt aufnehmen',
    'hero.stat1.num':  '10+',
    'hero.stat1.lbl':  'Jahre Erfahrung',
    'hero.stat2.num':  '200+',
    'hero.stat2.lbl':  'Zufriedene Mandanten',
    'hero.stat3.num':  '98%',
    'hero.stat3.lbl':  'Erfolgsquote',

    /* ── Teaser ── */
    'teaser.tax.title':  'Steuerberatung',
    'teaser.tax.text':   'Individuelle Steueroptimierung für Privatpersonen, Selbstständige und Unternehmen.',
    'teaser.tax.link':   'Mehr erfahren →',
    'teaser.ctrl.title': 'Controlling',
    'teaser.ctrl.text':  'Kennzahlenanalyse, Budgetplanung und Finanzreporting für fundierte Entscheidungen.',
    'teaser.ctrl.link':  'Mehr erfahren →',
    'teaser.acc.title':  'Jahresabschluss',
    'teaser.acc.text':   'Professionelle Erstellung von Jahresabschlüssen nach HGB und IFRS.',
    'teaser.acc.link':   'Mehr erfahren →',

    /* ── Über mich ── */
    'about.title':       'Über mich',
    'about.subtitle':    'Steuerberater, Controller und Finanzstratege aus Leidenschaft',
    'about.location':    'Berlin, Deutschland',
    'about.experience':  '10+ Jahre',
    'about.languages':   'Deutsch, Englisch',
    'about.p1':          '[Platzhalter: Ersetze diesen Text durch deine persönliche Vorstellung.]',
    'about.p2':          '[Platzhalter: Zweiter Absatz – dein Beratungsansatz und deine Werte.]',
